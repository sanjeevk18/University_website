...
export const metadata: Metadata = {
  title: 'Admin Login | State Allied Healthcare University',
  description: 'University admin panel - manage students, courses, fees, exams, and more.',
};
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      <div className="bg-black/30 backdrop-blur-sm text-white text-sm py-2 border-b border-white/10">
        <div className="container mx-auto px-4 flex justify-between items-center">
          <span>State Allied Healthcare University — Admin Portal</span>
          <Link href="/" className="underline hover:text-purple-300 transition-colors">← Back to Website</Link>
        </div>
      </div>
